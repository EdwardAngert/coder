...
air-gapped with Kubernetes or Docker. For the full set of networking-specific
air-gapped settings, see
[Air-gapped and offline deployments](../admin/networking/establishing-connections.md#air-gapped-and-offline-deployments).
...
| STUN                      | By default, Coder uses Google's public STUN server for direct workspace connections                                                                                                                                                                                | STUN can be safely [disabled](../reference/cli/server.md#--derp-server-stun-addresses); users can still connect via [relayed connections](../admin/networking/establishing-connections.md#falling-back-to-a-relayed-connection). Alternatively, you can set a [custom DERP server](../reference/cli/server.md#--derp-server-stun-addresses) |
...
| Coder Desktop / Connect   | Installed via Homebrew or WinGet, which reach public package repositories; the app auto-updates by default                                                                                                                                                         | Distribute the [manually downloaded installer](../user-guides/desktop/index.md#installation) and [disable automatic updates](../user-guides/desktop/index.md#disable-automatic-updates) via MDM or group policy. See [Coder Connect](../admin/networking/coder-connect.md#air-gapped-and-offline-deployments). |
